...
control MyIngress(inout headers hdr,
    ...
    bit<64> mul_tmp;
    bit<8> map_idx;
    bit<8> active_hidden1_count;
    bit<8> active_hidden2_count;
    bit<16> cand_0;
    bit<16> cand_1;
    bit<16> cand_2;
    bit<16> cand_3;
    ...
    register<bit<8>>(1) active_hidden1_count_reg;
    register<bit<8>>(1) active_hidden2_count_reg;
    ...
    action compute_output(bit<16> w0, bit<16> w1, bit<16> w2, bit<16> w3, bit<16> w4, bit<16> w5, bit<16> w6, bit<16> w7,
        ...
        // Multiply Hidden-2 Results by Output Weights
        acc = acc + ((int<32>)(int<16>)w0 * ((int<32>)meta.result2_0 >> 9));
        acc = acc + ((int<32>)(int<16>)w1 * ((int<32>)meta.result2_1 >> 9));
        acc = acc + ((int<32>)(int<16>)w2 * ((int<32>)meta.result2_2 >> 9));
        acc = acc + ((int<32>)(int<16>)w3 * ((int<32>)meta.result2_3 >> 9));
        acc = acc + ((int<32>)(int<16>)w4 * ((int<32>)meta.result2_4 >> 9));
        acc = acc + ((int<32>)(int<16>)w5 * ((int<32>)meta.result2_5 >> 9));
        acc = acc + ((int<32>)(int<16>)w6 * ((int<32>)meta.result2_6 >> 9));
        acc = acc + ((int<32>)(int<16>)w7 * ((int<32>)meta.result2_7 >> 9));
        acc = acc + ((int<32>)(int<16>)w8 * ((int<32>)meta.result2_8 >> 9));
        acc = acc + ((int<32>)(int<16>)w9 * ((int<32>)meta.result2_9 >> 9));
        acc = acc + ((int<32>)(int<16>)w10 * ((int<32>)meta.result2_10 >> 9));
        acc = acc + ((int<32>)(int<16>)w11 * ((int<32>)meta.result2_11 >> 9));
        acc = acc + ((int<32>)(int<16>)w12 * ((int<32>)meta.result2_12 >> 9));
        acc = acc + ((int<32>)(int<16>)w13 * ((int<32>)meta.result2_13 >> 9));
        acc = acc + ((int<32>)(int<16>)w14 * ((int<32>)meta.result2_14 >> 9));
        acc = acc + ((int<32>)(int<16>)w15 * ((int<32>)meta.result2_15 >> 9));

        acc = acc + bias_output;
        meta.nn_result = (int<32>)acc;
        debug_nn_result.write(0, meta.nn_result);
    }
    ...
    action compute_neuron2_0(bit<16> w0, bit<16> w1, bit<16> w2, bit<16> w3, bit<16> w4, bit<16> w5, bit<16> w6, bit<16> w7, bit<16> w8, bit<16> w9, bit<16> w10, bit<16> w11, bit<16> w12, bit<16> w13, bit<16> w14, bit<16> w15, bit<16> w16, bit<16> w17, bit<16> w18, bit<16> w19, bit<16> w20, bit<16> w21, bit<16> w22, bit<16> w23, bit<16> w24, bit<16> w25, bit<16> w26, bit<16> w27, bit<16> w28, bit<16> w29, bit<16> w30, bit<16> w31) {
        ...
        if (acc > 0) {
            meta.result2_0 = (int<32>)acc;
        } else {
            meta.result2_0 = 0;
        }
    }

    table neuron2_0_weights { actions = { compute_neuron2_0; NoAction; } default_action = NoAction(); }
    ...
    action compute_neuron2_1(bit<16> w0, bit<16> w1, bit<16> w2, bit<16> w3, bit<16> w4, bit<16> w5, bit<16> w6, bit<16> w7, bit<16> w8, bit<16> w9, bit<16> w10, bit<16> w11, bit<16> w12, bit<16> w13, bit<16> w14, bit<16> w15, bit<16> w16, bit<16> w17, bit<16> w18, bit<16> w19, bit<16> w20, bit<16> w21, bit<16> w22, bit<16> w23, bit<16> w24, bit<16> w25, bit<16> w26, bit<16> w27, bit<16> w28, bit<16> w29, bit<16> w30, bit<16> w31) {
        ...
        if (acc > 0) {
            meta.result2_1 = (int<32>)acc;
        } else {
            meta.result2_1 = 0;
        }
    }

    table neuron2_1_weights { actions = { compute_neuron2_1; NoAction; } default_action = NoAction(); }
    ...
    action compute_neuron2_2(bit<16> w0, bit<16> w1, bit<16> w2, bit<16> w3, bit<16> w4, bit<16> w5, bit<16> w6, bit<16> w7, bit<16> w8, bit<16> w9, bit<16> w10, bit<16> w11, bit<16> w12, bit<16> w13, bit<16> w14, bit<16> w15, bit<16> w16, bit<16> w17, bit<16> w18, bit<16> w19, bit<16> w20, bit<16> w21, bit<16> w22, bit<16> w23, bit<16> w24, bit<16> w25, bit<16> w26, bit<16> w27, bit<16> w28, bit<16> w29, bit<16> w30, bit<16> w31) {
        ...
        if (acc > 0) {
            meta.result2_2 = (int<32>)acc;
        } else {
            meta.result2_2 = 0;
        }
    }

    table neuron2_2_weights { actions = { compute_neuron2_2; NoAction; } default_action = NoAction(); }
    ...
    action compute_neuron2_3(bit<16> w0, bit<16> w1, bit<16> w2, bit<16> w3, bit<16> w4, bit<16> w5, bit<16> w6, bit<16> w7, bit<16> w8, bit<16> w9, bit<16> w10, bit<16> w11, bit<16> w12, bit<16> w13, bit<16> w14, bit<16> w15, bit<16> w16, bit<16> w17, bit<16> w18, bit<16> w19, bit<16> w20, bit<16> w21, bit<16> w22, bit<16> w23, bit<16> w24, bit<16> w25, bit<16> w26, bit<16> w27, bit<16> w28, bit<16> w29, bit<16> w30, bit<16> w31) {
        ...
        if (acc > 0) {
            meta.result2_3 = (int<32>)acc;
        } else {
            meta.result2_3 = 0;
        }
    }

    table neuron2_3_weights { actions = { compute_neuron2_3; NoAction; } default_action = NoAction(); }
    ...
    action compute_neuron2_4(bit<16> w0, bit<16> w1, bit<16> w2, bit<16> w3, bit<16> w4, bit<16> w5, bit<16> w6, bit<16> w7, bit<16> w8, bit<16> w9, bit<16> w10, bit<16> w11, bit<16> w12, bit<16> w13, bit<16> w14, bit<16> w15, bit<16> w16, bit<16> w17, bit<16> w18, bit<16> w19, bit<16> w20, bit<16> w21, bit<16> w22, bit<16> w23, bit<16> w24, bit<16> w25, bit<16> w26, bit<16> w27, bit<16> w28, bit<16> w29, bit<16> w30, bit<16> w31) {
        ...
        if (acc > 0) {
            meta.result2_4 = (int<32>)acc;
        } else {
            meta.result2_4 = 0;
        }
    }

    table neuron2_4_weights { actions = { compute_neuron2_4; NoAction; } default_action = NoAction(); }
    ...
    action compute_neuron2_5(bit<16> w0, bit<16> w1, bit<16> w2, bit<16> w3, bit<16> w4, bit<16> w5, bit<16> w6, bit<16> w7, bit<16> w8, bit<16> w9, bit<16> w10, bit<16> w11, bit<16> w12, bit<16> w13, bit<16> w14, bit<16> w15, bit<16> w16, bit<16> w17, bit<16> w18, bit<16> w19, bit<16> w20, bit<16> w21, bit<16> w22, bit<16> w23, bit<16> w24, bit<16> w25, bit<16> w26, bit<16> w27, bit<16> w28, bit<16> w29, bit<16> w30, bit<16> w31) {
        ...
        if (acc > 0) {
            meta.result2_5 = (int<32>)acc;
        } else {
            meta.result2_5 = 0;
        }
    }

    table neuron2_5_weights { actions = { compute_neuron2_5; NoAction; } default_action = NoAction(); }
    ...
    action compute_neuron2_6(bit<16> w0, bit<16> w1, bit<16> w2, bit<16> w3, bit<16> w4, bit<16> w5, bit<16> w6, bit<16> w7, bit<16> w8, bit<16> w9, bit<16> w10, bit<16> w11, bit<16> w12, bit<16> w13, bit<16> w14, bit<16> w15, bit<16> w16, bit<16> w17, bit<16> w18, bit<16> w19, bit<16> w20, bit<16> w21, bit<16> w22, bit<16> w23, bit<16> w24, bit<16> w25, bit<16> w26, bit<16> w27, bit<16> w28, bit<16> w29, bit<16> w30, bit<16> w31) {
        ...
        if (acc > 0) {
            meta.result2_6 = (int<32>)acc;
        } else {
            meta.result2_6 = 0;
        }
    }

    table neuron2_6_weights { actions = { compute_neuron2_6; NoAction; } default_action = NoAction(); }
    ...
    action compute_neuron2_7(bit<16> w0, bit<16> w1, bit<16> w2, bit<16> w3, bit<16> w4, bit<16> w5, bit<16> w6, bit<16> w7, bit<16> w8, bit<16> w9, bit<16> w10, bit<16> w11, bit<16> w12, bit<16> w13, bit<16> w14, bit<16> w15, bit<16> w16, bit<16> w17, bit<16> w18, bit<16> w19, bit<16> w20, bit<16> w21, bit<16> w22, bit<16> w23, bit<16> w24, bit<16> w25, bit<16> w26, bit<16> w27, bit<16> w28, bit<16> w29, bit<16> w30, bit<16> w31) {
        ...
        if (acc > 0) {
            meta.result2_7 = (int<32>)acc;
        } else {
            meta.result2_7 = 0;
        }
    }

    table neuron2_7_weights { actions = { compute_neuron2_7; NoAction; } default_action = NoAction(); }
    ...
    action compute_neuron2_8(bit<16> w0, bit<16> w1, bit<16> w2, bit<16> w3, bit<16> w4, bit<16> w5, bit<16> w6, bit<16> w7, bit<16> w8, bit<16> w9, bit<16> w10, bit<16> w11, bit<16> w12, bit<16> w13, bit<16> w14, bit<16> w15, bit<16> w16, bit<16> w17, bit<16> w18, bit<16> w19, bit<16> w20, bit<16> w21, bit<16> w22, bit<16> w23, bit<16> w24, bit<16> w25, bit<16> w26, bit<16> w27, bit<16> w28, bit<16> w29, bit<16> w30, bit<16> w31) {
        ...
        if (acc > 0) {
            meta.result2_8 = (int<32>)acc;
        } else {
            meta.result2_8 = 0;
        }
    }

    table neuron2_8_weights { actions = { compute_neuron2_8; NoAction; } default_action = NoAction(); }
    ...
    action compute_neuron2_9(bit<16> w0, bit<16> w1, bit<16> w2, bit<16> w3, bit<16> w4, bit<16> w5, bit<16> w6, bit<16> w7, bit<16> w8, bit<16> w9, bit<16> w10, bit<16> w11, bit<16> w12, bit<16> w13, bit<16> w14, bit<16> w15, bit<16> w16, bit<16> w17, bit<16> w18, bit<16> w19, bit<16> w20, bit<16> w21, bit<16> w22, bit<16> w23, bit<16> w24, bit<16> w25, bit<16> w26, bit<16> w27, bit<16> w28, bit<16> w29, bit<16> w30, bit<16> w31) {
        ...
        if (acc > 0) {
            meta.result2_9 = (int<32>)acc;
        } else {
            meta.result2_9 = 0;
        }
    }

    table neuron2_9_weights { actions = { compute_neuron2_9; NoAction; } default_action = NoAction(); }
    ...
    action compute_neuron2_10(bit<16> w0, bit<16> w1, bit<16> w2, bit<16> w3, bit<16> w4, bit<16> w5, bit<16> w6, bit<16> w7, bit<16> w8, bit<16> w9, bit<16> w10, bit<16> w11, bit<16> w12, bit<16> w13, bit<16> w14, bit<16> w15, bit<16> w16, bit<16> w17, bit<16> w18, bit<16> w19, bit<16> w20, bit<16> w21, bit<16> w22, bit<16> w23, bit<16> w24, bit<16> w25, bit<16> w26, bit<16> w27, bit<16> w28, bit<16> w29, bit<16> w30, bit<16> w31) {
        ...
        if (acc > 0) {
            meta.result2_10 = (int<32>)acc;
        } else {
            meta.result2_10 = 0;
        }
    }

    table neuron2_10_weights { actions = { compute_neuron2_10; NoAction; } default_action = NoAction(); }
    ...
    action compute_neuron2_11(bit<16> w0, bit<16> w1, bit<16> w2, bit<16> w3, bit<16> w4, bit<16> w5, bit<16> w6, bit<16> w7, bit<16> w8, bit<16> w9, bit<16> w10, bit<16> w11, bit<16> w12, bit<16> w13, bit<16> w14, bit<16> w15, bit<16> w16, bit<16> w17, bit<16> w18, bit<16> w19, bit<16> w20, bit<16> w21, bit<16> w22, bit<16> w23, bit<16> w24, bit<16> w25, bit<16> w26, bit<16> w27, bit<16> w28, bit<16> w29, bit<16> w30, bit<16> w31) {
        ...
        if (acc > 0) {
            meta.result2_11 = (int<32>)acc;
        } else {
            meta.result2_11 = 0;
        }
    }

    table neuron2_11_weights { actions = { compute_neuron2_11; NoAction; } default_action = NoAction(); }
    ...
    action compute_neuron2_12(bit<16> w0, bit<16> w1, bit<16> w2, bit<16> w3, bit<16> w4, bit<16> w5, bit<16> w6, bit<16> w7, bit<16> w8, bit<16> w9, bit<16> w10, bit<16> w11, bit<16> w12, bit<16> w13, bit<16> w14, bit<16> w15, bit<16> w16, bit<16> w17, bit<16> w18, bit<16> w19, bit<16> w20, bit<16> w21, bit<16> w22, bit<16> w23, bit<16> w24, bit<16> w25, bit<16> w26, bit<16> w27, bit<16> w28, bit<16> w29, bit<16> w30, bit<16> w31) {
        ...
        if (acc > 0) {
            meta.result2_12 = (int<32>)acc;
        } else {
            meta.result2_12 = 0;
        }
    }

    table neuron2_12_weights { actions = { compute_neuron2_12; NoAction; } default_action = NoAction(); }
    ...
    action compute_neuron2_13(bit<16> w0, bit<16> w1, bit<16> w2, bit<16> w3, bit<16> w4, bit<16> w5, bit<16> w6, bit<16> w7, bit<16> w8, bit<16> w9, bit<16> w10, bit<16> w11, bit<16> w12, bit<16> w13, bit<16> w14, bit<16> w15, bit<16> w16, bit<16> w17, bit<16> w18, bit<16> w19, bit<16> w20, bit<16> w21, bit<16> w22, bit<16> w23, bit<16> w24, bit<16> w25, bit<16> w26, bit<16> w27, bit<16> w28, bit<16> w29, bit<16> w30, bit<16> w31) {
        ...
        if (acc > 0) {
            meta.result2_13 = (int<32>)acc;
        } else {
            meta.result2_13 = 0;
        }
    }

    table neuron2_13_weights { actions = { compute_neuron2_13; NoAction; } default_action = NoAction(); }
    ...
    action compute_neuron2_14(bit<16> w0, bit<16> w1, bit<16> w2, bit<16> w3, bit<16> w4, bit<16> w5, bit<16> w6, bit<16> w7, bit<16> w8, bit<16> w9, bit<16> w10, bit<16> w11, bit<16> w12, bit<16> w13, bit<16> w14, bit<16> w15, bit<16> w16, bit<16> w17, bit<16> w18, bit<16> w19, bit<16> w20, bit<16> w21, bit<16> w22, bit<16> w23, bit<16> w24, bit<16> w25, bit<16> w26, bit<16> w27, bit<16> w28, bit<16> w29, bit<16> w30, bit<16> w31) {
        ...
        if (acc > 0) {
            meta.result2_14 = (int<32>)acc;
        } else {
            meta.result2_14 = 0;
        }
    }

    table neuron2_14_weights { actions = { compute_neuron2_14; NoAction; } default_action = NoAction(); }
    ...
    action compute_neuron2_15(bit<16> w0, bit<16> w1, bit<16> w2, bit<16> w3, bit<16> w4, bit<16> w5, bit<16> w6, bit<16> w7, bit<16> w8, bit<16> w9, bit<16> w10, bit<16> w11, bit<16> w12, bit<16> w13, bit<16> w14, bit<16> w15, bit<16> w16, bit<16> w17, bit<16> w18, bit<16> w19, bit<16> w20, bit<16> w21, bit<16> w22, bit<16> w23, bit<16> w24, bit<16> w25, bit<16> w26, bit<16> w27, bit<16> w28, bit<16> w29, bit<16> w30, bit<16> w31) {
        ...
        if (acc > 0) {
            meta.result2_15 = (int<32>)acc;
        } else {
            meta.result2_15 = 0;
        }
    }

    table neuron2_15_weights { actions = { compute_neuron2_15; NoAction; } default_action = NoAction(); }
    ...
    apply {
        if (hdr.ipv4.isValid()) {
            ...
            active_hidden1_count_reg.read(active_hidden1_count, 0);
            if (active_hidden1_count > 0) { neuron0_weights.apply(); } else { meta.result_0 = 0; }
            if (active_hidden1_count > 1) { neuron1_weights.apply(); } else { meta.result_1 = 0; }
            if (active_hidden1_count > 2) { neuron2_weights.apply(); } else { meta.result_2 = 0; }
            if (active_hidden1_count > 3) { neuron3_weights.apply(); } else { meta.result_3 = 0; }
            if (active_hidden1_count > 4) { neuron4_weights.apply(); } else { meta.result_4 = 0; }
            if (active_hidden1_count > 5) { neuron5_weights.apply(); } else { meta.result_5 = 0; }
            if (active_hidden1_count > 6) { neuron6_weights.apply(); } else { meta.result_6 = 0; }
            if (active_hidden1_count > 7) { neuron7_weights.apply(); } else { meta.result_7 = 0; }
            if (active_hidden1_count > 8) { neuron8_weights.apply(); } else { meta.result_8 = 0; }
            if (active_hidden1_count > 9) { neuron9_weights.apply(); } else { meta.result_9 = 0; }
            if (active_hidden1_count > 10) { neuron10_weights.apply(); } else { meta.result_10 = 0; }
            if (active_hidden1_count > 11) { neuron11_weights.apply(); } else { meta.result_11 = 0; }
            if (active_hidden1_count > 12) { neuron12_weights.apply(); } else { meta.result_12 = 0; }
            if (active_hidden1_count > 13) { neuron13_weights.apply(); } else { meta.result_13 = 0; }
            if (active_hidden1_count > 14) { neuron14_weights.apply(); } else { meta.result_14 = 0; }
            if (active_hidden1_count > 15) { neuron15_weights.apply(); } else { meta.result_15 = 0; }
            if (active_hidden1_count > 16) { neuron16_weights.apply(); } else { meta.result_16 = 0; }
            if (active_hidden1_count > 17) { neuron17_weights.apply(); } else { meta.result_17 = 0; }
            if (active_hidden1_count > 18) { neuron18_weights.apply(); } else { meta.result_18 = 0; }
            if (active_hidden1_count > 19) { neuron19_weights.apply(); } else { meta.result_19 = 0; }
            if (active_hidden1_count > 20) { neuron20_weights.apply(); } else { meta.result_20 = 0; }
            if (active_hidden1_count > 21) { neuron21_weights.apply(); } else { meta.result_21 = 0; }
            if (active_hidden1_count > 22) { neuron22_weights.apply(); } else { meta.result_22 = 0; }
            if (active_hidden1_count > 23) { neuron23_weights.apply(); } else { meta.result_23 = 0; }
            if (active_hidden1_count > 24) { neuron24_weights.apply(); } else { meta.result_24 = 0; }
            if (active_hidden1_count > 25) { neuron25_weights.apply(); } else { meta.result_25 = 0; }
            if (active_hidden1_count > 26) { neuron26_weights.apply(); } else { meta.result_26 = 0; }
            if (active_hidden1_count > 27) { neuron27_weights.apply(); } else { meta.result_27 = 0; }
            if (active_hidden1_count > 28) { neuron28_weights.apply(); } else { meta.result_28 = 0; }
            if (active_hidden1_count > 29) { neuron29_weights.apply(); } else { meta.result_29 = 0; }
            if (active_hidden1_count > 30) { neuron30_weights.apply(); } else { meta.result_30 = 0; }
            if (active_hidden1_count > 31) { neuron31_weights.apply(); } else { meta.result_31 = 0; }

            // Hidden layer 2 (32 -> 16)
            active_hidden2_count_reg.read(active_hidden2_count, 0);
            if (active_hidden2_count > 0) { neuron2_0_weights.apply(); } else { meta.result2_0 = 0; }
            if (active_hidden2_count > 1) { neuron2_1_weights.apply(); } else { meta.result2_1 = 0; }
            if (active_hidden2_count > 2) { neuron2_2_weights.apply(); } else { meta.result2_2 = 0; }
            if (active_hidden2_count > 3) { neuron2_3_weights.apply(); } else { meta.result2_3 = 0; }
            if (active_hidden2_count > 4) { neuron2_4_weights.apply(); } else { meta.result2_4 = 0; }
            if (active_hidden2_count > 5) { neuron2_5_weights.apply(); } else { meta.result2_5 = 0; }
            if (active_hidden2_count > 6) { neuron2_6_weights.apply(); } else { meta.result2_6 = 0; }
            if (active_hidden2_count > 7) { neuron2_7_weights.apply(); } else { meta.result2_7 = 0; }
            if (active_hidden2_count > 8) { neuron2_8_weights.apply(); } else { meta.result2_8 = 0; }
            if (active_hidden2_count > 9) { neuron2_9_weights.apply(); } else { meta.result2_9 = 0; }
            if (active_hidden2_count > 10) { neuron2_10_weights.apply(); } else { meta.result2_10 = 0; }
            if (active_hidden2_count > 11) { neuron2_11_weights.apply(); } else { meta.result2_11 = 0; }
            if (active_hidden2_count > 12) { neuron2_12_weights.apply(); } else { meta.result2_12 = 0; }
            if (active_hidden2_count > 13) { neuron2_13_weights.apply(); } else { meta.result2_13 = 0; }
            if (active_hidden2_count > 14) { neuron2_14_weights.apply(); } else { meta.result2_14 = 0; }
            if (active_hidden2_count > 15) { neuron2_15_weights.apply(); } else { meta.result2_15 = 0; }
