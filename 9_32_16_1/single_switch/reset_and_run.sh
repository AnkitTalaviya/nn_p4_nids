...
P4_JSON="$SCRIPT_DIR/p4/output/ids_neuralnet_dynamic_9_32_16_1.json"
OUT_DIR="$SCRIPT_DIR/python/output"
ACC_LOG="$OUT_DIR/final_switch_test.log"
ACC_CSV="$OUT_DIR/final_switch_results.csv"
P4_TMP_LOG="$(mktemp "/tmp/9_32_16_1_p4c_XXXX.log")"
SW_TMP_LOG="$(mktemp "/tmp/9_32_16_1_bmv2_XXXX.log")"
