...
# 9-4-1 end-to-end BMv2 deployment + accuracy/confusion-matrix test.
...
MODEL_JSON="${MODEL_JSON:-${REPO_ROOT}/9-4-1/offline/python/output/ptq_model_9_4_1.json}"
...
ACC_LOG="${OUT_DIR}/final_switch_test_9_4_1.log"
ACC_CSV="${OUT_DIR}/final_switch_results_9_4_1.csv"
P4_TMP_LOG="$(mktemp "/tmp/9_4_1_p4c_XXXX.log")"
SW_TMP_LOG="$(mktemp "/tmp/9_4_1_bmv2_XXXX.log")"
...
echo "--- 0) GENERATE COMMANDS (9-4-1 -> BMv2 tables) ---"
...
echo "--- 5) RUN 9-4-1 ACCURACY + CONFUSION MATRIX TEST ---"
