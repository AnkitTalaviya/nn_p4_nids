...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--num-switches", type=int, default=4, help="Number of switches (>=2)")
    ap.add_argument(
        "--output-dir",
        type=Path,
        default=SCRIPT_DIR,
...
def main() -> int:
    ...
    print("[dynamic-wrapper] generating multi-switch commands with one_hidden profile")
